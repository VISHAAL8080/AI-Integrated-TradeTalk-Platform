    ...
    <div className="authLayout">
      ...
      <div className="authPanel">
        <div className="authCard">
          <h1 className="authTitle">Sign up with email</h1>
